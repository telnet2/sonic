...
LBB2_5:
	...
	MOVQ    R13, DX
	SHLQ    $4, DX
	LONG    $0xa40d8d48; WORD $0x0080; BYTE $0x00 // leaq         $32932(%rip), %rcx  /* _DOUBLE_POW5_INV_SPLIT(%rip) */
	MOVQ    R8, SI
	ORQ     $2, SI
	MOVQ    0(DX)(CX*1), AX
	MOVQ    8(DX)(CX*1), R10
...
LBB2_12:
	...
	MOVLQSX AX, SI
	SHLQ    $4, SI
	LONG    $0xd00d8d4c; WORD $0x0094; BYTE $0x00 // leaq         $38096(%rip), %r9  /* _DOUBLE_POW5_SPLIT(%rip) */
	MOVQ    R8, CX
	ORQ     $2, CX
	MOVQ    0(SI)(R9*1), R10
	MOVQ    R10, AX
...
LBB2_65:
	...
	LEAL    0(AX)(AX*4), AX
	SUBL    AX, R14
	LONG    $0xc5058d48; WORD $0x00a3; BYTE $0x00 // leaq         $41925(%rip), %rax  /* _Digits(%rip) */
...
LBB2_69:
	...
	JL      LBB2_84
	MOVLQSX R14, AX
	LONG    $0x5c0d8d48; WORD $0x00a3; BYTE $0x00 // leaq         $41820(%rip), %rcx  /* _Digits(%rip) */
...
LBB2_73:
	...
	ADDQ  -56(BP), SI
	MOVL  R15, DX
	LONG  $0x004924e8; BYTE $0x00 // callq        _print_mantissa
	TESTL R12, R12
	JE    LBB2_77
	LEAL  0(R12)(BX*1), AX
	CMPL  R12, R15
...
LBB2_110:
	...
	MOVL R15, DX
	WORD $0xf8c5; BYTE $0x77     // vzeroupper
	LONG $0x0045c3e8; BYTE $0x00 // callq        _print_mantissa
	ADDL BX, R15
	MOVL R15, BX
...
_u64toa:
	...
	CMPL    SI, $1000
	JB      LBB4_3
	LONG    $0xcf0d8d48; WORD $0x009e; BYTE $0x00 // leaq         $40655(%rip), %rcx  /* _Digits(%rip) */
	MOVB    0(DX)(CX*1), CX
	MOVB    CX, 0(DI)
	MOVL    $1, CX
	JMP     LBB4_4
...
LBB4_4:
	MOVWLZX DX, DX
	ORQ     $1, DX
	LONG    $0xae358d48; WORD $0x009e; BYTE $0x00 // leaq         $40622(%rip), %rsi  /* _Digits(%rip) */
	MOVB    0(DX)(SI*1), DX
	MOVL    CX, SI
	ADDL    $1, CX
	MOVB    DX, 0(DI)(SI*1)
...
LBB4_6:
	LONG $0x9c158d48; WORD $0x009e; BYTE $0x00 // leaq         $40604(%rip), %rdx  /* _Digits(%rip) */
	MOVB 0(AX)(DX*1), DX
	MOVL CX, SI
	ADDL $1, CX
	MOVB DX, 0(DI)(SI*1)
...
LBB4_7:
	MOVWLZX AX, AX
	ORQ     $1, AX
	LONG    $0x83158d48; WORD $0x009e; BYTE $0x00 // leaq         $40579(%rip), %rdx  /* _Digits(%rip) */
	MOVB    0(AX)(DX*1), AX
	MOVL    CX, DX
	ADDL    $1, CX
	MOVB    AX, 0(DI)(DX*1)
...
LBB4_8:
	...
	CMPL    SI, $10000000
	JB      LBB4_11
	LONG    $0xeb058d48; WORD $0x009d; BYTE $0x00 // leaq         $40427(%rip), %rax  /* _Digits(%rip) */
	MOVB    0(R10)(AX*1), AX
	MOVB    AX, 0(DI)
	MOVL    $1, CX
	JMP     LBB4_12
...
LBB4_12:
	MOVL R10, AX
	ORQ  $1, AX
	LONG $0xc6358d48; WORD $0x009d; BYTE $0x00 // leaq         $40390(%rip), %rsi  /* _Digits(%rip) */
	MOVB 0(AX)(SI*1), AX
	MOVL CX, SI
	ADDL $1, CX
	MOVB AX, 0(DI)(SI*1)
...
LBB4_14:
	LONG $0xb4058d48; WORD $0x009d; BYTE $0x00 // leaq         $40372(%rip), %rax  /* _Digits(%rip) */
	MOVB 0(R9)(AX*1), AX
	MOVL CX, SI
	ADDL $1, CX
	MOVB AX, 0(DI)(SI*1)
...
LBB4_15:
	MOVWLZX R9, AX
	ORQ     $1, AX
	LONG    $0x99358d48; WORD $0x009d; BYTE $0x00 // leaq         $40345(%rip), %rsi  /* _Digits(%rip) */
	MOVB    0(AX)(SI*1), AX
	MOVL    CX, DX
	MOVB    AX, 0(DI)(DX*1)
	MOVB    0(R8)(SI*1), AX
...
LBB4_16:
	...
	SUBL AX, CX
	SHLQ $4, AX
	LONG $0x10158d48; WORD $0x009d; BYTE $0x00 // leaq         $40208(%rip), %rdx  /* _VecShiftShuffles(%rip) */
...
LBB4_20:
	...
	JA   LBB4_22
	MOVL DX, AX
	LONG $0xf30d8d48; WORD $0x009b; BYTE $0x00 // leaq         $39923(%rip), %rcx  /* _Digits(%rip) */
	MOVB 0(CX)(AX*2), DX
	MOVB 1(CX)(AX*2), AX
	MOVB DX, 0(DI)
	MOVB AX, 1(DI)
...
LBB4_22:
	...
	SUBL    CX, AX
	MOVWLZX AX, AX
	LONG    $0xa20d8d48; WORD $0x009b; BYTE $0x00 // leaq         $39842(%rip), %rcx  /* _Digits(%rip) */
	MOVB    0(CX)(AX*2), DX
	MOVB    1(CX)(AX*2), AX
	MOVB    DX, 1(DI)
	MOVB    AX, 2(DI)
...
LBB4_24:
	...
	SUBL    CX, DX
	MOVWLZX AX, AX
	LONG    $0x7f058d4c; WORD $0x009b; BYTE $0x00 // leaq         $39807(%rip), %r8  /* _Digits(%rip) */
	MOVB    0(R8)(AX*2), CX
	MOVB    1(R8)(AX*2), AX
	MOVB    CX, 0(DI)
	MOVB    AX, 1(DI)
...
LBB4_25:
	...
	SHRQ $26, DX
	LONG $0xc26ef9c5               // vmovd        %edx, %xmm0
	QUAD $0xfffffbe30d6ffac5       // vmovdqu      $-1053(%rip), %xmm1  /* LCPI4_0(%rip) */
	LONG $0xd1f4f9c5               // vpmuludq     %xmm1, %xmm0, %xmm2
	LONG $0xd273e9c5; BYTE $0x2d   // vpsrlq       $45, %xmm2, %xmm2
	MOVL $10000, AX
	LONG $0x6ef9e1c4; BYTE $0xd8   // vmovq        %rax, %xmm3
	...
	LONG $0xc070fbc5; BYTE $0x50   // vpshuflw     $80, %xmm0, %xmm0
	LONG $0xc070f9c5; BYTE $0x50   // vpshufd      $80, %xmm0, %xmm0
	QUAD $0xfffffbdd1512fbc5       // vmovddup     $-1059(%rip), %xmm2  /* LCPI4_1(%rip) */
	LONG $0xc2e4f9c5               // vpmulhuw     %xmm2, %xmm0, %xmm0
	QUAD $0xfffffbd92512fbc5       // vmovddup     $-1063(%rip), %xmm4  /* LCPI4_2(%rip) */
	LONG $0xc4e4f9c5               // vpmulhuw     %xmm4, %xmm0, %xmm0
	QUAD $0xfffffba52d6ffac5       // vmovdqu      $-1115(%rip), %xmm5  /* LCPI4_3(%rip) */
	LONG $0xf5d5f9c5               // vpmullw      %xmm5, %xmm0, %xmm6
	LONG $0xf673c9c5; BYTE $0x10   // vpsllq       $16, %xmm6, %xmm6
	LONG $0xc6f9f9c5               // vpsubw       %xmm6, %xmm0, %xmm0
	LONG $0xe100c269; WORD $0x05f5 // imull        $100000000, %edx, %eax
	...
	LONG $0xcaf9f1c5               // vpsubw       %xmm2, %xmm1, %xmm1
	LONG $0xc167f9c5               // vpackuswb    %xmm1, %xmm0, %xmm0
	QUAD $0xfffffb5705fcf9c5       // vpaddb       $-1193(%rip), %xmm0, %xmm0  /* LCPI4_4(%rip) */
	MOVL CX, AX
...
_quote:
	...
	LONG  $0x7d158d4c; WORD $0x00ab; BYTE $0x00 // leaq         $43901(%rip), %r10  /* __DoubleQuoteTab(%rip) */
	LONG  $0xd0440f4c                           // cmoveq       %rax, %r10
	MOVQ  DX, R8
	MOVQ  DI, AX
	TESTQ SI, SI
...
LBB5_9:
	...
	ORL   $65536, CX
	LONG  $0xbc0f44f3; BYTE $0xc9 // tzcntl       %ecx, %r9d
...
LBB5_16:
	...
	MOVQ    DI, DX
	SHLQ    $4, DX
	LONG    $0x181d8d48; WORD $0x009a; BYTE $0x00 // leaq         $39448(%rip), %rbx  /* __SingleQuoteTab(%rip) */
	CMPQ    0(DX)(BX*1), $0
	JNE     LBB5_26
	LEAQ    0(R9)(CX*1), R14
	MOVB    DI, 0(R13)(R10*1)
...
LBB5_22:
	MOVWLZX DX, CX
	LONG    $0xbc0f44f3; BYTE $0xf9 // tzcntl       %ecx, %r15d
	ADDQ    R13, R15
	JMP     LBB5_39
...
_unquote:
	...
	MOVL  R8, R10
	ANDL  $1, R10
	LONG  $0x620d8d48; WORD $0x00b7; BYTE $0x00 // leaq         $46946(%rip), %rcx  /* __UnquoteTab(%rip) */
...
LBB6_8:
	MOVWLZX BX, BX
	LONG    $0xbc0f4cf3; BYTE $0xf3 // tzcntq       %rbx, %r14
	ADDQ    R12, R14
	CMPQ    R14, $-1
	JE      LBB6_115
...
_html_escape:
	...
	LONG  $0x411d8d4c; WORD $0x00af; BYTE $0x00 // leaq         $44865(%rip), %r11  /* __HtmlQuoteTab(%rip) */
	MOVQ  DI, R12
	MOVQ  -48(BP), R14
...
LBB7_12:
	...
	LONG  $0xc5d7f9c5             // vpmovmskb    %xmm5, %eax
	ORL   $65536, AX
	LONG  $0xbc0f44f3; BYTE $0xd0 // tzcntl       %eax, %r10d
...
LBB7_20:
	SUBQ DX, R15
	ADDQ DX, BX
	LONG $0xe11d8d4c; WORD $0x00ad; BYTE $0x00 // leaq         $44513(%rip), %r11  /* __HtmlQuoteTab(%rip) */
...
LBB7_8:
	MOVWLZX AX, AX
	LONG    $0xbc0f44f3; BYTE $0xf8 // tzcntl       %eax, %r15d
	ADDQ    R8, R15
	TESTQ   R15, R15
	JNS     LBB7_49
	JMP     LBB7_48
...
LBB7_45:
	SUBQ  R12, R15
	SUBQ  AX, R15
	LONG  $0x7e1d8d4c; WORD $0x00ad; BYTE $0x00 // leaq         $44414(%rip), %r11  /* __HtmlQuoteTab(%rip) */
	TESTQ R15, R15
	JNS   LBB7_49
	JMP   LBB7_48
...
LBB8_5:
	...
	MOVL AX, CX
	SHLQ $4, CX
	LONG $0x413d8d4c; WORD $0x0033; BYTE $0x00 // leaq         $13121(%rip), %r15  /* _POW10_M128_TAB(%rip) */
	MOVQ DI, AX
	MULQ 8(CX)(R15*1)
	MOVQ AX, R11
	MOVQ DX, R14
...
LBB9_5:
	...
	JLE   LBB9_12
	XORL  R12, R12
	LONG  $0x70358d4c; WORD $0x005d; BYTE $0x00 // leaq         $23920(%rip), %r14  /* _POW_TAB(%rip) */
	JMP   LBB9_8
...
LBB9_11:
	MOVQ R15, DI
	MOVL BX, SI
	LONG $0x00305fe8; BYTE $0x00 // callq        _right_shift
...
LBB9_12:
	LONG $0x32358d4c; WORD $0x005d; BYTE $0x00 // leaq         $23858(%rip), %r14  /* _POW_TAB(%rip) */
	JMP  LBB9_14
...
LBB9_20:
	MOVQ R15, DI
	MOVL BX, SI
	LONG $0x002e92e8; BYTE $0x00 // callq        _left_shift
	MOVL 20(R15), AX
...
LBB9_25:
	MOVQ R15, DI
	MOVL $60, SI
	LONG $0x002fc1e8; BYTE $0x00 // callq        _right_shift
	ADDL $60, R12
	CMPL R12, $-120
	JL   LBB9_25
	ADDL $60, R12
...
LBB9_31:
	...
	MOVQ R15, DI
	MOVL R12, SI
	LONG $0x002f7ae8; BYTE $0x00 // callq        _right_shift
	MOVL $-1022, R14
...
LBB9_32:
	...
	MOVQ R15, DI
	MOVL $53, SI
	LONG $0x002dd0e8; BYTE $0x00 // callq        _left_shift
...
LBB10_40:
	LEAQ -32(BP), DI
	LEAQ -40(BP), SI
	LONG $0xfffb5be8; BYTE $0xff // callq        _decimal_to_f64
...
_string_length:
	...
	JB    LBB11_10
	XORL  AX, AX
	QUAD  $0xffffffb4056ffac5 // vmovdqu      $-76(%rip), %xmm0  /* LCPI11_0(%rip) */
	QUAD  $0xffffffbc0d6ffac5 // vmovdqu      $-68(%rip), %xmm1  /* LCPI11_1(%rip) */
	XORL  R11, R11
	XORL  R10, R10
	JMP   LBB11_5
...
LBB11_8:
	LONG  $0xf2a842c4; BYTE $0xc1   // andnq        %r9, %r10, %r8
	LEAQ  0(R8)(R8*1), R14
	ORQ   R10, R14
	LONG  $0xf288c2c4; BYTE $0xd1   // andnq        %r9, %r14, %rdx
...
LBB11_11:
	...
	QUAD  $0xfffffe5a156ffac5     // vmovdqu      $-422(%rip), %xmm2  /* LCPI11_0(%rip) */
	...
	QUAD  $0xfffffe52156ffac5     // vmovdqu      $-430(%rip), %xmm2  /* LCPI11_1(%rip) */
	LONG  $0xc274f9c5             // vpcmpeqb     %xmm2, %xmm0, %xmm0
	LONG  $0xc0d779c5             // vpmovmskb    %xmm0, %r8d
	LONG  $0xc274f1c5             // vpcmpeqb     %xmm2, %xmm1, %xmm0
...
LBB11_14:
	...
	TESTL BX, BX
	SETEQ AX
	LONG  $0xbc0f49f3; BYTE $0xd6 // tzcntq       %r14, %rdx
	MOVQ  AX, CX
	NEGQ  CX
	XORQ  DX, CX
	ADDQ  CX, R11
	LONG  $0xf388c2c4; BYTE $0xce // blsrq        %r14, %r14
	MOVL  AX, BX
	JNE   LBB11_14
	JMP   LBB11_17

LBB11_15:
	LONG  $0xf22842c4; BYTE $0xc8 // andnl        %r8d, %r10d, %r9d
	LEAL  0(R9)(R9*1), DX
	ORL   R10, DX
	LONG  $0xf268c2c4; BYTE $0xc8 // andnl        %r8d, %edx, %ecx
	ANDL  $-1431655766, CX
	XORL  R10, R10
	ADDL  R9, CX
	SETCS R10
	...
	XORL  $1431655765, CX
	ANDL  DX, CX
	LONG  $0xf27042c4; BYTE $0xf6 // andnl        %r14d, %ecx, %r14d
	TESTQ R14, R14
	JNE   LBB11_14
...
LBB12_2:
	...
	LEAQ -40(BP), SI
	MOVQ R14, DX
	LONG $0x000a6be8; BYTE $0x00 // callq        _vnumber
	MOVQ -40(BP), BX
	JMP  LBB12_18
...
LBB12_5:
	...
	LEAQ  -48(BP), DX
	MOVQ  R15, SI
	LONG  $0x0006aee8; BYTE $0x00 // callq        _advance_string
	TESTQ AX, AX
	JS    LBB12_25
	MOVQ  AX, -40(BP)
	MOVQ  R15, 16(R14)
...
LBB13_30:
	MOVWLZX AX, AX
	NOTL    AX
	LONG    $0xbc0f44f3; BYTE $0xc0 // tzcntl       %eax, %r8d
	SUBQ    CX, R8
...
LBB15_9:
	LONG  $0xf28862c4; BYTE $0xc0   // andnq        %rax, %r14, %r8
	LEAQ  0(R8)(R8*1), DI
	ORQ   R14, DI
	LONG  $0xf2c0e2c4; BYTE $0xc0   // andnq        %rax, %rdi, %rax
...
LBB15_13:
	...
	QUAD $0xfffffe47156ffac5     // vmovdqu      $-441(%rip), %xmm2  /* LCPI15_0(%rip) */
	QUAD $0xfffffe4f1d6ffac5     // vmovdqu      $-433(%rip), %xmm3  /* LCPI15_1(%rip) */
...
LBB16_61:
	...
	JL    LBB16_72
	LEAL  -22(SI), AX
	LONG  $0xea0d8d48; WORD $0x00bc; BYTE $0x00 // leaq         $48362(%rip), %rcx  /* _P10_TAB(%rip) */
...
LBB16_69:
	...
	JB   LBB16_76
	NEGL SI
	LONG $0xa1058d48; WORD $0x00bc; BYTE $0x00 // leaq         $48289(%rip), %rax  /* _P10_TAB(%rip) */
...
LBB16_73:
	...
	JA   LBB16_76
	MOVL AX, AX
	LONG $0x2d0d8d48; WORD $0x00bc; BYTE $0x00 // leaq         $48173(%rip), %rcx  /* _P10_TAB(%rip) */
	LONG $0x0459fbc5; BYTE $0xc1               // vmulsd       (%rcx,%rax,8), %xmm0, %xmm0
	LONG $0x4511fbc5; BYTE $0xc0               // vmovsd       %xmm0, $-64(%rbp)
	JMP  LBB16_80
...
LBB16_76:
	...
	MOVL  R10, BX
	MOVQ  SI, -88(BP)
	LONG  $0xffe7eae8; BYTE $0xff // callq        _atof_eisel_lemire64
	TESTB AX, AX
	JE    LBB16_81
	MOVQ  -88(BP), SI
	CMPL  -44(BP), $0
	...
	LEAQ  -80(BP), CX
	MOVQ  R12, DI
	LONG  $0xffe7cae8; BYTE $0xff // callq        _atof_eisel_lemire64
	TESTB AX, AX
	JE    LBB16_81
...
LBB16_81:
	...
	MOVQ -104(BP), DX
	MOVQ -96(BP), CX
	LONG $0xffebc9e8; BYTE $0xff // callq        _atof_native
	LONG $0x4511fbc5; BYTE $0xc0 // vmovsd       %xmm0, $-64(%rbp)
	LONG $0x7ef9e1c4; BYTE $0xc0 // vmovq        %xmm0, %rax
	JMP  LBB16_84
...
LBB20_4:
	...
	MOVQ    -56(BP), BX
	MOVQ    BX, DX
	LONG    $0xfff1d0e8; BYTE $0xff // callq        _advance_ns
	MOVLQSX 0(R12), DX
	LEAQ    -1(DX), CX
	CMPQ    R14, $-1
	JNE     LBB20_6
...
LBB20_17:
	MOVQ  R15, SI
	LEAQ  -72(BP), DX
	LONG  $0xfff388e8; BYTE $0xff // callq        _advance_string
	MOVQ  AX, R13
	TESTQ AX, AX
	JS    LBB20_56
	MOVQ  R13, 0(BX)
...
LBB20_28:
	...
	MOVQ  8(AX), SI
	SUBQ  R13, SI
	LONG  $0x000d20e8; BYTE $0x00 // callq        _skip_number
	LEAQ  -1(AX), CX
	MOVQ  $-2, DX
	SUBQ  AX, DX
	TESTQ AX, AX
...
LBB20_35:
	...
	MOVQ  R15, SI
	LEAQ  -72(BP), DX
	LONG  $0xfff21ee8; BYTE $0xff // callq        _advance_string
	MOVQ  AX, R13
	TESTQ AX, AX
	JS    LBB20_56
	MOVQ  R13, 0(BX)
...
LBB20_42:
	...
	MOVQ  8(AX), SI
	SUBQ  R13, SI
	LONG  $0x000bf6e8; BYTE $0x00 // callq        _skip_number
	TESTQ AX, AX
	JS    LBB20_63
	ADDQ  R13, AX
	MOVQ  AX, 0(BX)
...
_skip_string:
	...
	LEAQ  -32(BP), DX
	MOVQ  BX, SI
	LONG  $0xffed29e8; BYTE $0xff // callq        _advance_string
	TESTQ AX, AX
	JS    LBB23_2
	ADDQ  $-1, BX
	MOVQ  AX, CX
...
_validate_string:
	...
	MOVQ $-1, R11
	XORL R12, R12
	QUAD $0xffffff7a056f7ac5 // vmovdqu      $-134(%rip), %xmm8  /* LCPI24_0(%rip) */
	QUAD $0xffffff820d6ffac5 // vmovdqu      $-126(%rip), %xmm1  /* LCPI24_1(%rip) */
	QUAD $0xffffff8a156ffac5 // vmovdqu      $-118(%rip), %xmm2  /* LCPI24_2(%rip) */
	LONG $0xdb76e1c5         // vpcmpeqd     %xmm3, %xmm3, %xmm3

LBB24_4:
	LONG  $0x6f7a81c4; WORD $0x3d7c; BYTE $0x00 // vmovdqu      (%r13,%r15), %xmm7
	LONG  $0x6f7a81c4; WORD $0x3d74; BYTE $0x10 // vmovdqu      $16(%r13,%r15), %xmm6
	LONG  $0x6f7a81c4; WORD $0x3d6c; BYTE $0x20 // vmovdqu      $32(%r13,%r15), %xmm5
	LONG  $0x6f7a81c4; WORD $0x3d64; BYTE $0x30 // vmovdqu      $48(%r13,%r15), %xmm4
...
LBB24_7:
	LONG  $0xf298e2c4; BYTE $0xc6   // andnq        %rsi, %r12, %rax
	LEAQ  0(AX)(AX*1), CX
	ORQ   R12, CX
	LONG  $0xf2f0e2c4; BYTE $0xd6   // andnq        %rsi, %rcx, %rdx
	...
	XORQ  AX, DX
	ANDQ  CX, DX
	LONG  $0xf2e842c4; BYTE $0xf6   // andnq        %r14, %rdx, %r14
	ORQ   R10, BX
	TESTQ R14, R14
	JE    LBB24_14
	JMP   LBB24_9
...
LBB24_5:
	LONG $0xbc0f4cf3; BYTE $0xde // tzcntq       %rsi, %r11
	ADDQ R15, R11
	JMP  LBB24_6

LBB24_9:
	LONG  $0xbc0f49f3; BYTE $0xce // tzcntq       %r14, %rcx
	LEAQ  0(CX)(R15*1), R12
	ADDQ  $1, R12
	TESTQ BX, BX
	JE    LBB24_10
...
LBB24_51:
	...
	ADDQ  R12, SI
	MOVQ  -56(BP), DI
	LONG  $0x0002cae8; BYTE $0x00 // callq        _utf8_validate
	ADDQ  AX, BX
	TESTQ AX, AX
	LONG  $0xdc480f49             // cmovsq       %r12, %rbx
	MOVQ  $-2, R12
	LONG  $0xe7480f4d             // cmovsq       %r15, %r12
	MOVQ  BX, R11
	JMP   LBB24_55
...
LBB24_21:
	...
	LONG  $0x6f7ac1c4; WORD $0x104f // vmovdqu      $16(%r15), %xmm1
	QUAD  $0xfffffd22156ffac5       // vmovdqu      $-734(%rip), %xmm2  /* LCPI24_0(%rip) */
	LONG  $0xda74f9c5               // vpcmpeqb     %xmm2, %xmm0, %xmm3
	LONG  $0xd3d779c5               // vpmovmskb    %xmm3, %r10d
	LONG  $0xd274f1c5               // vpcmpeqb     %xmm2, %xmm1, %xmm2
	LONG  $0xc2d7f9c5               // vpmovmskb    %xmm2, %eax
	QUAD  $0xfffffd1a156ffac5       // vmovdqu      $-742(%rip), %xmm2  /* LCPI24_1(%rip) */
	LONG  $0xda74f9c5               // vpcmpeqb     %xmm2, %xmm0, %xmm3
	LONG  $0xdbd7f9c5               // vpmovmskb    %xmm3, %ebx
	LONG  $0xd274f1c5               // vpcmpeqb     %xmm2, %xmm1, %xmm2
	LONG  $0xcad7f9c5               // vpmovmskb    %xmm2, %ecx
	QUAD  $0xfffffd12156ffac5       // vmovdqu      $-750(%rip), %xmm2  /* LCPI24_2(%rip) */
...
LBB24_17:
	LONG $0xbc0f4cf3; BYTE $0xdb // tzcntq       %rbx, %r11
	ADDQ R15, R11
	MOVQ DI, R14
	JMP  LBB24_55
...
LBB24_24:
	LONG  $0xf218e2c4; BYTE $0xcb // andnl        %ebx, %r12d, %ecx
	LEAL  0(CX)(CX*1), DX
	ORL   R12, DX
...
_utf8_validate:
	...
	TESTQ SI, SI
	JLE   LBB25_28
	LONG  $0x5a0d8d4c; WORD $0x00ac; BYTE $0x00 // leaq         $44122(%rip), %r9  /* _first(%rip) */
	LONG  $0x53058d4c; WORD $0x00ad; BYTE $0x00 // leaq         $44371(%rip), %r8  /* _ranges(%rip) */
	LONG  $0x31158d4c; WORD $0x0001; BYTE $0x00 // leaq         $305(%rip), %r10  /* LJTI25_0(%rip) */
	MOVQ  DI, R14
...
LBB25_7:
	MOVWLZX CX, CX
	LONG    $0xbc0f48f3; BYTE $0xd1 // tzcntq       %rcx, %rdx
	SUBQ    BX, DX
	CMPQ    DX, $-1
	JNE     LBB25_9
	JMP     LBB25_28
...
LJTI25_0:
	LONG $0xffffffcb // .long L25_0_set_27
	LONG $0xfffffff3 // .long L25_0_set_26
	LONG $0xffffffae // .long L25_0_set_23
	LONG $0xffffffa1 // .long L25_0_set_21
	LONG $0xffffff94 // .long L25_0_set_19
...
LBB27_9:
	...
	MOVL $-1, BX
	SHLL CX, BX
	LONG $0xf260e2c4; BYTE $0xd2 // andnl        %edx, %ebx, %edx
	LONG $0xf26042c4; BYTE $0xff // andnl        %r15d, %ebx, %r15d
	LONG $0xf26042c4; BYTE $0xf6 // andnl        %r14d, %ebx, %r14d

LBB27_11:
	LONG  $0xf360e2c4; BYTE $0xca // blsrl        %edx, %ebx
	JNE   LBB27_12
	LONG  $0xf360c2c4; BYTE $0xcf // blsrl        %r15d, %ebx
	JNE   LBB27_12
	LONG  $0xf360c2c4; BYTE $0xce // blsrl        %r14d, %ebx
	JNE   LBB27_12
	TESTL DX, DX
	JE    LBB27_19
	LONG  $0xd2bc0ff3             // tzcntl       %edx, %edx
	CMPQ  R8, $-1
	JNE   LBB27_56
	ADDQ  AX, DX
	MOVQ  DX, R8
...
LBB27_19:
	TESTL R15, R15
	JE    LBB27_22
	LONG  $0xbc0f41f3; BYTE $0xd7 // tzcntl       %r15d, %edx
	CMPQ  R9, $-1
	JNE   LBB27_56
	ADDQ  AX, DX
	MOVQ  DX, R9
...
LBB27_22:
	TESTL R14, R14
	JE    LBB27_25
	LONG  $0xbc0f41f3; BYTE $0xd6 // tzcntl       %r14d, %edx
	CMPQ  R10, $-1
	JNE   LBB27_56
	ADDQ  AX, DX
	MOVQ  DX, R10
...
LBB27_28:
	...
	SUBQ DI, R14
	XORL AX, AX
	LONG $0x3c1d8d4c; WORD $0x0001; BYTE $0x00 // leaq         $316(%rip), %r11  /* LJTI27_0(%rip) */
	JMP  LBB27_29
...
LJTI27_0:
	LONG $0xfffffeff // .long L27_0_set_37
	LONG $0xffffff3c // .long L27_0_set_40
	LONG $0xfffffeff // .long L27_0_set_37
	LONG $0xffffff0f // .long L27_0_set_35
	LONG $0xffffff3c // .long L27_0_set_40
	LONG $0xffffff3c // .long L27_0_set_40
	LONG $0xffffff3c // .long L27_0_set_40
	LONG $0xffffff3c // .long L27_0_set_40
	...
	LONG $0xffffff3c // .long L27_0_set_40
	LONG $0xffffff3c // .long L27_0_set_40
	LONG $0xfffffecb // .long L27_0_set_32
...
_skip_positive:
	...
	SUBQ  BX, SI
	MOVQ  AX, DI
	LONG  $0xfffc6fe8; BYTE $0xff // callq        _skip_number
	LEAQ  -1(AX), DX
	MOVQ  $-2, CX
	MOVQ  $-2, SI
	SUBQ  AX, SI
...
_f64toa:
	MOVQ  out+0(FP), DI
	MOVSD val+8(FP), X0
	CALL  ·__native_entry__+571(SB) // _f64toa
	MOVQ  AX, ret+16(FP)
	RET
...
_html_escape:
	...
	MOVQ dp+16(FP), DX
	MOVQ dn+24(FP), CX
	CALL ·__native_entry__+8275(SB) // _html_escape
	MOVQ AX, ret+32(FP)
	RET
...
_i64toa:
	MOVQ out+0(FP), DI
	MOVQ val+8(FP), SI
	CALL ·__native_entry__+3620(SB) // _i64toa
	MOVQ AX, ret+16(FP)
	RET
...
_quote:
	...
	MOVQ dn+24(FP), CX
	MOVQ flags+32(FP), R8
	CALL ·__native_entry__+4938(SB) // _quote
	MOVQ AX, ret+40(FP)
	RET
...
_skip_array:
	...
	MOVQ p+8(FP), SI
	MOVQ m+16(FP), DX
	CALL ·__native_entry__+18229(SB) // _skip_array
	MOVQ AX, ret+24(FP)
	RET
...
_skip_object:
	...
	MOVQ p+8(FP), SI
	MOVQ m+16(FP), DX
	CALL ·__native_entry__+18266(SB) // _skip_object
	MOVQ AX, ret+24(FP)
	RET
...
_skip_one:
	...
	MOVQ p+8(FP), SI
	MOVQ m+16(FP), DX
	CALL ·__native_entry__+16381(SB) // _skip_one
	MOVQ AX, ret+24(FP)
	RET
...
_string_length:
	MOVQ sp+0(FP), DI
	MOVQ nb+8(FP), SI
	CALL ·__native_entry__+10914(SB) // _string_length
	MOVQ AX, ret+16(FP)
	RET
...
_u64toa:
	MOVQ out+0(FP), DI
	MOVQ val+8(FP), SI
	CALL ·__native_entry__+3715(SB) // _u64toa
	MOVQ AX, ret+16(FP)
	RET
...
_unquote:
	...
	MOVQ ep+24(FP), CX
	MOVQ flags+32(FP), R8
	CALL ·__native_entry__+5980(SB) // _unquote
	MOVQ AX, ret+40(FP)
	RET
...
_validate_one:
	...
	MOVQ p+8(FP), SI
	MOVQ m+16(FP), DX
	CALL ·__native_entry__+21219(SB) // _validate_one
	MOVQ AX, ret+24(FP)
	RET
...
_value:
	...
	CALL ·__native_entry__+11635(SB) // _value
	MOVQ AX, ret+40(FP)
	RET
...
_vnumber:
	...
	MOVQ p+8(FP), SI
	MOVQ v+16(FP), DX
	LEAQ ·__native_entry__+14395(SB), AX // _vnumber
	JMP  AX
...
_vsigned:
	...
	MOVQ p+8(FP), SI
	MOVQ v+16(FP), DX
	LEAQ ·__native_entry__+15825(SB), AX // _vsigned
	JMP  AX
...
_vstring:
	...
	MOVQ p+8(FP), SI
	MOVQ v+16(FP), DX
	LEAQ ·__native_entry__+13368(SB), AX // _vstring
	JMP  AX
...
_vunsigned:
	...
	MOVQ p+8(FP), SI
	MOVQ v+16(FP), DX
	LEAQ ·__native_entry__+16105(SB), AX // _vunsigned
	JMP  AX
