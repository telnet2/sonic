...
LBB2_2:
	...
	MOVL $13312, DX
	LONG $0xf7e8e2c4; BYTE $0xc9 // bextrq       %rdx, %rcx, %rcx
	ADDQ $1, DI
	ORQ  CX, DI
	LEAL -1023(AX), DX
	CMPL DX, $52
	...
	MOVL DX, SI
	SHLL $8, SI
	LONG $0xf7c8e2c4; BYTE $0xf7 // bextrq       %rsi, %rdi, %rsi
	JE   LBB2_14
...
LBB2_5:
	...
	MOVQ    R13, DX
	SHLQ    $4, DX
	LONG    $0x960d8d48; WORD $0x008c; BYTE $0x00 // leaq         $35990(%rip), %rcx  /* _DOUBLE_POW5_INV_SPLIT(%rip) */
	MOVQ    R8, SI
	ORQ     $2, SI
	MOVQ    0(DX)(CX*1), AX
	MOVQ    8(DX)(CX*1), R10
	...
	ADDL    BX, CX
	ADDB    $61, CX
	LONG    $0xdcad0f4d                           // shrdq        %cl, %r11, %r12
	SHRQ    CX, R11
	NOTQ    DI
	ADDQ    R8, DI
	MOVQ    R15, R14
...
LBB2_12:
	LONG    $0x05ee6945; WORD $0xf4d1; BYTE $0xff // imull        $-732923, %r14d, %r13d
	SHRL    $20, R13
	XORL    AX, AX
	CMPL    R14, $-1
	SETNE   AX
	...
	MOVL    R14, AX
	NEGL    AX
	LONG    $0xb1de6941; WORD $0xed6c; BYTE $0xff // imull        $-1217359, %r14d, %ebx
	SHRL    $19, BX
	MOVLQSX AX, SI
	SHLQ    $4, SI
	LONG    $0xc20d8d4c; WORD $0x00a0; BYTE $0x00 // leaq         $41154(%rip), %r9  /* _DOUBLE_POW5_SPLIT(%rip) */
	MOVQ    R8, CX
	ORQ     $2, CX
	MOVQ    0(SI)(R9*1), R10
	MOVQ    R10, AX
	...
	SUBL    BX, CX
	ADDB    $60, CX
	LONG    $0xdead0f4c                           // shrdq        %cl, %r11, %rsi
	SHRQ    CX, R11
	NOTQ    DI
	ADDQ    R8, DI
	MOVQ    R10, AX
...
LBB2_15:
	...
	JA    LBB2_24
	SHLL  $8, R13
	LONG  $0xf790c2c4; BYTE $0xc0 // bextrq       %r13, %r8, %rax
	SETEQ R15
	JMP   LBB2_25
...
LBB2_60:
	...
	MOVQ BX, SI
	MOVL R15, DX
	LONG $0x005617e8; BYTE $0x00 // callq        _print_mantissa
	MOVB 1(R12), AX
	MOVB AX, 0(R12)
	MOVL $1, AX
	CMPL R15, $2
...
LBB2_65:
	...
	LEAL    0(AX)(AX*4), AX
	SUBL    AX, R14
	LONG    $0xb7058d48; WORD $0x00af; BYTE $0x00 // leaq         $44983(%rip), %rax  /* _Digits(%rip) */
...
LBB2_69:
	...
	JL      LBB2_84
	MOVLQSX R14, AX
	LONG    $0x4e0d8d48; WORD $0x00af; BYTE $0x00 // leaq         $44878(%rip), %rcx  /* _Digits(%rip) */
...
LBB2_73:
	...
	ADDQ  -56(BP), SI
	MOVL  R15, DX
	LONG  $0x005516e8; BYTE $0x00 // callq        _print_mantissa
	TESTL R12, R12
	JE    LBB2_77
	LEAL  0(R12)(BX*1), AX
	CMPL  R12, R15
...
LBB2_88:
	...
	NEGQ SI
	XORL DI, DI
	QUAD $0xfffff6ab056ffec5 // vmovdqu      $-2389(%rip), %ymm0  /* LCPI2_0(%rip) */
...
LBB2_90:
	...
	SHLQ  $7, DX
	XORL  SI, SI
	QUAD  $0xfffff5fc056ffec5 // vmovdqu      $-2564(%rip), %ymm0  /* LCPI2_0(%rip) */
...
LBB2_98:
	...
	NEGQ DX
	XORL SI, SI
	QUAD $0xfffff57d056ffec5 // vmovdqu      $-2691(%rip), %ymm0  /* LCPI2_0(%rip) */

LBB2_99:
	LONG $0x7f7ec1c4; WORD $0x3444; BYTE $0x02 // vmovdqu      %ymm0, $2(%r12,%rsi)
	LONG $0x7f7ec1c4; WORD $0x3444; BYTE $0x22 // vmovdqu      %ymm0, $34(%r12,%rsi)
	LONG $0x7f7ec1c4; WORD $0x3444; BYTE $0x42 // vmovdqu      %ymm0, $66(%r12,%rsi)
	LONG $0x7f7ec1c4; WORD $0x3444; BYTE $0x62 // vmovdqu      %ymm0, $98(%r12,%rsi)
	QUAD $0x008234847f7ec1c4; WORD $0x0000     // vmovdqu      %ymm0, $130(%r12,%rsi)
	QUAD $0x00a234847f7ec1c4; WORD $0x0000     // vmovdqu      %ymm0, $162(%r12,%rsi)
	QUAD $0x00c234847f7ec1c4; WORD $0x0000     // vmovdqu      %ymm0, $194(%r12,%rsi)
	QUAD $0x00e234847f7ec1c4; WORD $0x0000     // vmovdqu      %ymm0, $226(%r12,%rsi)
	QUAD $0x010234847f7ec1c4; WORD $0x0000     // vmovdqu      %ymm0, $258(%r12,%rsi)
	QUAD $0x012234847f7ec1c4; WORD $0x0000     // vmovdqu      %ymm0, $290(%r12,%rsi)
	QUAD $0x014234847f7ec1c4; WORD $0x0000     // vmovdqu      %ymm0, $322(%r12,%rsi)
	QUAD $0x016234847f7ec1c4; WORD $0x0000     // vmovdqu      %ymm0, $354(%r12,%rsi)
	QUAD $0x018234847f7ec1c4; WORD $0x0000     // vmovdqu      %ymm0, $386(%r12,%rsi)
	QUAD $0x01a234847f7ec1c4; WORD $0x0000     // vmovdqu      %ymm0, $418(%r12,%rsi)
	QUAD $0x01c234847f7ec1c4; WORD $0x0000     // vmovdqu      %ymm0, $450(%r12,%rsi)
	QUAD $0x01e234847f7ec1c4; WORD $0x0000     // vmovdqu      %ymm0, $482(%r12,%rsi)
	ADDQ $512, SI
	ADDQ $4, DX
	JNE  LBB2_99
...
LBB2_100:
	...
	JE    LBB2_103
	NEGQ  AX
	QUAD  $0xfffff4c8056ffec5 // vmovdqu      $-2872(%rip), %ymm0  /* LCPI2_0(%rip) */

LBB2_102:
	MOVQ SI, DX
	ORQ  $2, DX
	LONG $0x7f7ec1c4; WORD $0x1404             // vmovdqu      %ymm0, (%r12,%rdx)
	LONG $0x7f7ec1c4; WORD $0x1444; BYTE $0x20 // vmovdqu      %ymm0, $32(%r12,%rdx)
	LONG $0x7f7ec1c4; WORD $0x1444; BYTE $0x40 // vmovdqu      %ymm0, $64(%r12,%rdx)
	LONG $0x7f7ec1c4; WORD $0x1444; BYTE $0x60 // vmovdqu      %ymm0, $96(%r12,%rdx)
	SUBQ $-128, SI
	INCQ AX
	JNE  LBB2_102
...
LBB2_110:
	...
	MOVL R15, DX
	WORD $0xf8c5; BYTE $0x77     // vzeroupper
	LONG $0x0051b5e8; BYTE $0x00 // callq        _print_mantissa
	ADDL BX, R15
	MOVL R15, BX
...
LBB2_113:
	MOVL  $16128, AX
	LONG  $0xf7f8e2c4; BYTE $0xc9 // bextrq       %rax, %rcx, %rcx
	MOVB  $45, 0(R12)
	ADDQ  $1, R12
	MOVL  $1, R9
	TESTQ CX, CX
...
_u64toa:
	...
	CMPL    SI, $1000
	JB      LBB4_3
	LONG    $0xc10d8d48; WORD $0x00aa; BYTE $0x00 // leaq         $43713(%rip), %rcx  /* _Digits(%rip) */
	MOVB    0(DX)(CX*1), CX
	MOVB    CX, 0(DI)
	MOVL    $1, CX
	JMP     LBB4_4
...
LBB4_4:
	MOVWLZX DX, DX
	ORQ     $1, DX
	LONG    $0xa0358d48; WORD $0x00aa; BYTE $0x00 // leaq         $43680(%rip), %rsi  /* _Digits(%rip) */
	MOVB    0(DX)(SI*1), DX
	MOVL    CX, SI
	ADDL    $1, CX
	MOVB    DX, 0(DI)(SI*1)
...
LBB4_6:
	LONG $0x8e158d48; WORD $0x00aa; BYTE $0x00 // leaq         $43662(%rip), %rdx  /* _Digits(%rip) */
	MOVB 0(AX)(DX*1), DX
	MOVL CX, SI
	ADDL $1, CX
	MOVB DX, 0(DI)(SI*1)
...
LBB4_7:
	MOVWLZX AX, AX
	ORQ     $1, AX
	LONG    $0x75158d48; WORD $0x00aa; BYTE $0x00 // leaq         $43637(%rip), %rdx  /* _Digits(%rip) */
	MOVB    0(AX)(DX*1), AX
	MOVL    CX, DX
	ADDL    $1, CX
	MOVB    AX, 0(DI)(DX*1)
...
LBB4_12:
	MOVL R10, AX
	ORQ  $1, AX
	LONG $0xb8358d48; WORD $0x00a9; BYTE $0x00 // leaq         $43448(%rip), %rsi  /* _Digits(%rip) */
	MOVB 0(AX)(SI*1), AX
	MOVL CX, SI
	ADDL $1, CX
	MOVB AX, 0(DI)(SI*1)
...
LBB4_14:
	LONG $0xa6058d48; WORD $0x00a9; BYTE $0x00 // leaq         $43430(%rip), %rax  /* _Digits(%rip) */
	MOVB 0(R9)(AX*1), AX
	MOVL CX, SI
	ADDL $1, CX
	MOVB AX, 0(DI)(SI*1)
...
LBB4_15:
	MOVWLZX R9, AX
	ORQ     $1, AX
	LONG    $0x8b358d48; WORD $0x00a9; BYTE $0x00 // leaq         $43403(%rip), %rsi  /* _Digits(%rip) */
	MOVB    0(AX)(SI*1), AX
	MOVL    CX, DX
	MOVB    AX, 0(DI)(DX*1)
	MOVB    0(R8)(SI*1), AX
...
LBB4_16:
	...
	SUBL AX, CX
	SHLQ $4, AX
	LONG $0x00158d48; WORD $0x00a9; BYTE $0x00 // leaq         $43264(%rip), %rdx  /* _VecShiftShuffles(%rip) */
...
LBB4_20:
	...
	JA   LBB4_22
	MOVL DX, AX
	LONG $0xe30d8d48; WORD $0x00a7; BYTE $0x00 // leaq         $42979(%rip), %rcx  /* _Digits(%rip) */
	MOVB 0(CX)(AX*2), DX
	MOVB 1(CX)(AX*2), AX
	MOVB DX, 0(DI)
	MOVB AX, 1(DI)
...
LBB4_22:
	...
	SUBL    CX, AX
	MOVWLZX AX, AX
	LONG    $0x920d8d48; WORD $0x00a7; BYTE $0x00 // leaq         $42898(%rip), %rcx  /* _Digits(%rip) */
	MOVB    0(CX)(AX*2), DX
	MOVB    1(CX)(AX*2), AX
	MOVB    DX, 1(DI)
	MOVB    AX, 2(DI)
...
LBB4_24:
	...
	SUBL    CX, DX
	MOVWLZX AX, AX
	LONG    $0x6f058d4c; WORD $0x00a7; BYTE $0x00 // leaq         $42863(%rip), %r8  /* _Digits(%rip) */
	MOVB    0(R8)(AX*2), CX
	MOVB    1(R8)(AX*2), AX
	MOVB    CX, 0(DI)
	MOVB    AX, 1(DI)
...
LBB4_25:
	...
	SHRQ $26, DX
	LONG $0xc26ef9c5                     // vmovd        %edx, %xmm0
	QUAD $0xfffffbe10d6ffac5             // vmovdqu      $-1055(%rip), %xmm1  /* LCPI4_0(%rip) */
	LONG $0xd1f4f9c5                     // vpmuludq     %xmm1, %xmm0, %xmm2
	LONG $0xd273e9c5; BYTE $0x2d         // vpsrlq       $45, %xmm2, %xmm2
	MOVL $10000, AX
	LONG $0x6ef9e1c4; BYTE $0xd8         // vmovq        %rax, %xmm3
	...
	LONG $0xf073f9c5; BYTE $0x02         // vpsllq       $2, %xmm0, %xmm0
	LONG $0xc070fbc5; BYTE $0x50         // vpshuflw     $80, %xmm0, %xmm0
	QUAD $0xfffbdf155979e2c4; BYTE $0xff // vpbroadcastq $-1057(%rip), %xmm2  /* LCPI4_1(%rip) */
	LONG $0xc070f9c5; BYTE $0x50         // vpshufd      $80, %xmm0, %xmm0
	LONG $0xc2e4f9c5                     // vpmulhuw     %xmm2, %xmm0, %xmm0
	QUAD $0xfffbd5255979e2c4; BYTE $0xff // vpbroadcastq $-1067(%rip), %xmm4  /* LCPI4_2(%rip) */
	LONG $0xc4e4f9c5                     // vpmulhuw     %xmm4, %xmm0, %xmm0
	QUAD $0xfffffba12d6ffac5             // vmovdqu      $-1119(%rip), %xmm5  /* LCPI4_3(%rip) */
	LONG $0xf5d5f9c5                     // vpmullw      %xmm5, %xmm0, %xmm6
	LONG $0xf673c9c5; BYTE $0x10         // vpsllq       $16, %xmm6, %xmm6
	LONG $0xc6f9f9c5                     // vpsubw       %xmm6, %xmm0, %xmm0
	LONG $0xe100c269; WORD $0x05f5       // imull        $100000000, %edx, %eax
	...
	LONG $0xcaf9f1c5                     // vpsubw       %xmm2, %xmm1, %xmm1
	LONG $0xc167f9c5                     // vpackuswb    %xmm1, %xmm0, %xmm0
	QUAD $0xfffffb5305fcf9c5             // vpaddb       $-1197(%rip), %xmm0, %xmm0  /* LCPI4_4(%rip) */
	MOVL CX, AX
...
_quote:
	...
	SUBQ  $32, SP
	TESTB $1, R8
	LONG  $0x12058d48; WORD $0x00a7; BYTE $0x00 // leaq         $42770(%rip), %rax  /* __SingleQuoteTab(%rip) */
	LONG  $0x0b158d4c; WORD $0x00b7; BYTE $0x00 // leaq         $46859(%rip), %r10  /* __DoubleQuoteTab(%rip) */
	LONG  $0xd0440f4c                           // cmoveq       %rax, %r10
	MOVQ  DX, R8
	MOVQ  DI, AX
	TESTQ SI, SI
...
LBB5_10:
	...
	MOVQ  $4294967296, DX
	ORQ   DX, CX
	LONG  $0xbc0f4cf3; BYTE $0xf1   // tzcntq       %rcx, %r14
...
LBB5_36:
	...
	MOVQ  AX, CX
	SUBQ  R12, CX
	QUAD  $0xfffffdb30d6f7ec5     // vmovdqu      $-589(%rip), %ymm9  /* LCPI5_0(%rip) */
	QUAD  $0xfffffdcb156f7ec5     // vmovdqu      $-565(%rip), %ymm10  /* LCPI5_1(%rip) */
	QUAD  $0xfffffde31d6f7ec5     // vmovdqu      $-541(%rip), %ymm11  /* LCPI5_2(%rip) */
	LONG  $0x763d41c4; BYTE $0xc0 // vpcmpeqd     %ymm8, %ymm8, %ymm8
	QUAD  $0xfffffdf63d6ffac5     // vmovdqu      $-522(%rip), %xmm7  /* LCPI5_3(%rip) */
	QUAD  $0xfffffdfe256ffac5     // vmovdqu      $-514(%rip), %xmm4  /* LCPI5_4(%rip) */
	QUAD  $0xfffffe062d6ffac5     // vmovdqu      $-506(%rip), %xmm5  /* LCPI5_5(%rip) */
...
LBB5_51:
	...
	ORL  $65536, CX
	LONG $0xf9bc0ff3               // tzcntl       %ecx, %edi
	LONG $0x7ef9e1c4; BYTE $0xc1   // vmovq        %xmm0, %rcx
	CMPQ R14, DI
	JGE  LBB5_52
	CMPQ R14, $8
...
LBB5_6:
	LONG $0xbc0f44f3; BYTE $0xe1 // tzcntl       %ecx, %r12d
	ADDQ R13, R12
	JMP  LBB5_79
...
LBB5_37:
	MOVQ  BX, R14
	MOVQ  R15, R9
	QUAD  $0xfffffc6d0d6f7ec5     // vmovdqu      $-915(%rip), %ymm9  /* LCPI5_0(%rip) */
	QUAD  $0xfffffc85156f7ec5     // vmovdqu      $-891(%rip), %ymm10  /* LCPI5_1(%rip) */
	QUAD  $0xfffffc9d1d6f7ec5     // vmovdqu      $-867(%rip), %ymm11  /* LCPI5_2(%rip) */
	LONG  $0x763d41c4; BYTE $0xc0 // vpcmpeqd     %ymm8, %ymm8, %ymm8
	QUAD  $0xfffffcb03d6ffac5     // vmovdqu      $-848(%rip), %xmm7  /* LCPI5_3(%rip) */
	QUAD  $0xfffffcb8256ffac5     // vmovdqu      $-840(%rip), %xmm4  /* LCPI5_4(%rip) */
	QUAD  $0xfffffcc02d6ffac5     // vmovdqu      $-832(%rip), %xmm5  /* LCPI5_5(%rip) */
	LONG  $0xf676c9c5             // vpcmpeqd     %xmm6, %xmm6, %xmm6
	TESTB DX, DX
	JNE   LBB5_51
...
LBB5_48:
	...
	MOVQ    DI, BX
	SHLQ    $4, BX
	LONG    $0xd1358d48; WORD $0x00a3; BYTE $0x00 // leaq         $41937(%rip), %rsi  /* __SingleQuoteTab(%rip) */
	CMPQ    0(BX)(SI*1), $0
	JNE     LBB5_49
	LEAQ    0(R9)(CX*1), R15
	MOVB    DI, 0(R13)(DX*1)
...
LBB5_41:
	MOVWLZX DX, DX
	LONG    $0xbc0f44f3; BYTE $0xe2 // tzcntl       %edx, %r12d
	JMP     LBB5_50
...
LBB6_35:
	MOVWLZX CX, AX
	LONG    $0xbc0f4cf3; BYTE $0xf0 // tzcntq       %rax, %r14
	SUBQ    R13, R14
	CMPQ    R14, $-1
	JE      LBB6_87
...
LBB6_38:
	ADDQ    R14, R8
	MOVBLZX -1(R9), AX
	LONG    $0x170d8d48; WORD $0x00bd; BYTE $0x00 // leaq         $48407(%rip), %rcx  /* __UnquoteTab(%rip) */
	MOVB    0(AX)(CX*1), CX
	CMPB    CX, $-1
	JE      LBB6_41
	TESTB   CX, CX
...
_html_escape:
	...
	LONG  $0xe63d8d4c; WORD $0x00b6; BYTE $0x00 // leaq         $46822(%rip), %r15  /* __HtmlQuoteTab(%rip) */
	MOVQ  -48(BP), R11
	MOVQ  -56(BP), R8
...
LBB7_12:
	...
	MOVQ  $4294967296, DX
	ORQ   DX, CX
	LONG  $0xbc0f4cf3; BYTE $0xe9   // tzcntq       %rcx, %r13
	LONG  $0x6f7ac1c4; WORD $0x2404 // vmovdqu      (%r12), %xmm0
	LONG  $0x16f9e3c4; WORD $0x01c1 // vpextrq      $1, %xmm0, %rcx
	LONG  $0x7ef9e1c4; BYTE $0xc2   // vmovq        %xmm0, %rdx
	CMPQ  R13, AX
...
LBB7_38:
	...
	JL    LBB7_39
	CMPQ  R10, $16
	QUAD  $0xfffffe333d6ffac5 // vmovdqu      $-461(%rip), %xmm7  /* LCPI7_4(%rip) */
	QUAD  $0xfffffe3b056f7ac5 // vmovdqu      $-453(%rip), %xmm8  /* LCPI7_5(%rip) */
	QUAD  $0xfffffe430d6f7ac5 // vmovdqu      $-445(%rip), %xmm9  /* LCPI7_6(%rip) */
	QUAD  $0xfffffe4b156f7ac5 // vmovdqu      $-437(%rip), %xmm10  /* LCPI7_7(%rip) */
	JL    LBB7_41
	MOVQ  R11, DI
	SUBQ  R12, DI
	QUAD  $0xfffffd871d6ffec5 // vmovdqu      $-633(%rip), %ymm3  /* LCPI7_0(%rip) */
	QUAD  $0xfffffd9f256ffec5 // vmovdqu      $-609(%rip), %ymm4  /* LCPI7_1(%rip) */
	QUAD  $0xfffffdb72d6ffec5 // vmovdqu      $-585(%rip), %ymm5  /* LCPI7_2(%rip) */
	QUAD  $0xfffffdcf356ffec5 // vmovdqu      $-561(%rip), %ymm6  /* LCPI7_3(%rip) */
...
LBB7_8:
	LONG  $0xbc0f44f3; BYTE $0xe0 // tzcntl       %eax, %r12d
	ADDQ  BX, R12
	TESTQ R12, R12
	JNS   LBB7_84
	JMP   LBB7_83
...
LBB7_39:
	MOVQ AX, R13
	MOVQ R10, R14
	QUAD $0xfffffc4e1d6ffec5 // vmovdqu      $-946(%rip), %ymm3  /* LCPI7_0(%rip) */
	QUAD $0xfffffc66256ffec5 // vmovdqu      $-922(%rip), %ymm4  /* LCPI7_1(%rip) */
	QUAD $0xfffffc7e2d6ffec5 // vmovdqu      $-898(%rip), %ymm5  /* LCPI7_2(%rip) */
	QUAD $0xfffffc96356ffec5 // vmovdqu      $-874(%rip), %ymm6  /* LCPI7_3(%rip) */
	QUAD $0xfffffcae3d6ffac5 // vmovdqu      $-850(%rip), %xmm7  /* LCPI7_4(%rip) */
	QUAD $0xfffffcb6056f7ac5 // vmovdqu      $-842(%rip), %xmm8  /* LCPI7_5(%rip) */
	QUAD $0xfffffcbe0d6f7ac5 // vmovdqu      $-834(%rip), %xmm9  /* LCPI7_6(%rip) */
	QUAD $0xfffffcc6156f7ac5 // vmovdqu      $-826(%rip), %xmm10  /* LCPI7_7(%rip) */
...
LBB7_41:
	MOVQ  AX, R13
	MOVQ  R10, R14
	QUAD  $0xfffffb9e1d6ffec5 // vmovdqu      $-1122(%rip), %ymm3  /* LCPI7_0(%rip) */
	QUAD  $0xfffffbb6256ffec5 // vmovdqu      $-1098(%rip), %ymm4  /* LCPI7_1(%rip) */
	QUAD  $0xfffffbce2d6ffec5 // vmovdqu      $-1074(%rip), %ymm5  /* LCPI7_2(%rip) */
	QUAD  $0xfffffbe6356ffec5 // vmovdqu      $-1050(%rip), %ymm6  /* LCPI7_3(%rip) */
	TESTB CX, CX
	JNE   LBB7_58
...
LBB8_5:
	...
	MOVL AX, CX
	SHLQ $4, CX
	LONG $0xf23d8d4c; WORD $0x0037; BYTE $0x00 // leaq         $14322(%rip), %r15  /* _POW10_M128_TAB(%rip) */
	MOVQ DI, AX
	MULQ 8(CX)(R15*1)
	MOVQ AX, R11
	MOVQ DX, R14
...
LBB8_16:
	...
	SHLQ $52, R10
	MOVL $13312, AX
	LONG $0xf7f8e2c4; BYTE $0xc2   // bextrq       %rax, %rdx, %rax
	ORQ  R10, AX
...
LBB9_5:
	...
	JLE   LBB9_12
	XORL  R12, R12
	LONG  $0xe9358d4c; WORD $0x0061; BYTE $0x00 // leaq         $25065(%rip), %r14  /* _POW_TAB(%rip) */
	JMP   LBB9_8
...
LBB9_11:
	MOVQ R15, DI
	MOVL BX, SI
	LONG $0x0034d8e8; BYTE $0x00 // callq        _right_shift
...
LBB9_12:
	LONG $0xab358d4c; WORD $0x0061; BYTE $0x00 // leaq         $25003(%rip), %r14  /* _POW_TAB(%rip) */
	JMP  LBB9_14
...
LBB9_20:
	MOVQ R15, DI
	MOVL BX, SI
	LONG $0x00330be8; BYTE $0x00 // callq        _left_shift
	MOVL 20(R15), AX
...
LBB9_25:
	MOVQ R15, DI
	MOVL $60, SI
	LONG $0x00343ae8; BYTE $0x00 // callq        _right_shift
	ADDL $60, R12
	CMPL R12, $-120
	JL   LBB9_25
	ADDL $60, R12
...
LBB9_31:
	...
	MOVQ R15, DI
	MOVL R12, SI
	LONG $0x0033f3e8; BYTE $0x00 // callq        _right_shift
	MOVL $-1022, R14
...
LBB9_32:
	...
	MOVQ R15, DI
	MOVL $53, SI
	LONG $0x003249e8; BYTE $0x00 // callq        _left_shift
...
LBB9_34:
	...
	MOVL  CX, DX
	SARL  $31, DX
	LONG  $0xf268e2c4; BYTE $0xd1 // andnl        %ecx, %edx, %edx
	LEAQ  -1(AX), R9
	CMPQ  R9, DX
...
LBB9_41:
	...
	JB   LBB9_52
	MOVL DX, R8
	QUAD $0xfffffdbb056ffac5               // vmovdqu      $-581(%rip), %xmm0  /* LCPI9_0(%rip) */
	LONG $0x22f9c3c4; WORD $0x00c4         // vpinsrq      $0, %r12, %xmm0, %xmm0
	ANDL $-16, R8
	QUAD $0xfffda705027de3c4; WORD $0xf0ff // vpblendd     $240, $-601(%rip), %ymm0, %ymm0  /* LCPI9_0(%rip) */
	LEAL -16(R8), CX
	MOVL CX, DI
	SHRL $4, DI
	ADDL $1, DI
	...
	CMPL CX, $48
	JAE  LBB9_45
	QUAD $0xfffda815597de2c4; BYTE $0xff   // vpbroadcastq $-600(%rip), %ymm2  /* LCPI9_1(%rip) */
...
LBB9_45:
	ANDL $-4, DI
	NEGL DI
	QUAD $0xfffd9015597de2c4; BYTE $0xff // vpbroadcastq $-624(%rip), %ymm2  /* LCPI9_1(%rip) */
	QUAD $0xfffd8f25597de2c4; BYTE $0xff // vpbroadcastq $-625(%rip), %ymm4  /* LCPI9_2(%rip) */
	LONG $0xda6ffdc5                     // vmovdqa      %ymm2, %ymm3
	LONG $0xca6ffdc5                     // vmovdqa      %ymm2, %ymm1
...
LBB9_47:
	...
	JE    LBB9_50
	NEGL  SI
	QUAD  $0xfffd2325597de2c4; BYTE $0xff // vpbroadcastq $-733(%rip), %ymm4  /* LCPI9_3(%rip) */
...
LBB10_40:
	LEAQ -32(BP), DI
	LEAQ -40(BP), SI
	LONG $0xfff97be8; BYTE $0xff // callq        _decimal_to_f64
...
_string_length:
	...
	JB    LBB11_10
	XORL  AX, AX
	QUAD  $0xffffff98056ffec5       // vmovdqu      $-104(%rip), %ymm0  /* LCPI11_0(%rip) */
	QUAD  $0xffffffb00d6ffec5       // vmovdqu      $-80(%rip), %ymm1  /* LCPI11_1(%rip) */
	MOVQ  $-6148914691236517206, R8
	MOVQ  $6148914691236517205, R9
	XORL  R11, R11
	XORL  R10, R10
	JMP   LBB11_5
...
LBB11_5:
	...
	LONG  $0xd2d7fdc5             // vpmovmskb    %ymm2, %edx
	SHLQ  $32, BX
	ORQ   BX, CX
	SHLQ  $32, DX
	ORQ   DX, R14
...
LBB11_7:
	...
	TESTL AX, AX
	SETEQ DX
	LONG  $0xbc0f48f3; BYTE $0xc1 // tzcntq       %rcx, %rax
	MOVQ  DX, BX
	NEGQ  BX
	XORQ  AX, BX
	ADDQ  BX, R11
	LONG  $0xf3f0e2c4; BYTE $0xc9 // blsrq        %rcx, %rcx
	MOVL  DX, AX
	JNE   LBB11_7
	JMP   LBB11_4

LBB11_8:
	LONG  $0xf2a842c4; BYTE $0xfe // andnq        %r14, %r10, %r15
	LEAQ  0(R15)(R15*1), BX
	ORQ   R10, BX
	LONG  $0xf2e0c2c4; BYTE $0xd6 // andnq        %r14, %rbx, %rdx
	ANDQ  R8, DX
	XORL  R10, R10
	ADDQ  R15, DX
	SETCS R10
	...
	XORQ  R9, DX
	ANDQ  BX, DX
	LONG  $0xf2e8e2c4; BYTE $0xc9 // andnq        %rcx, %rdx, %rcx
	TESTQ CX, CX
	JNE   LBB11_7
	JMP   LBB11_3
...
LBB11_11:
	...
	JB    LBB11_19
	LONG  $0x076ffec5         // vmovdqu      (%rdi), %ymm0
	QUAD  $0xfffffe8d0d74fdc5 // vpcmpeqb     $-371(%rip), %ymm0, %ymm1  /* LCPI11_0(%rip) */
	LONG  $0xc1d7fdc5         // vpmovmskb    %ymm1, %eax
	QUAD  $0xfffffea10574fdc5 // vpcmpeqb     $-351(%rip), %ymm0, %ymm0  /* LCPI11_1(%rip) */
	LONG  $0xc8d7fdc5         // vpmovmskb    %ymm0, %ecx
	TESTQ R10, R10
	JNE   LBB11_16
	TESTL CX, CX
...
LBB11_15:
	...
	XORQ  DX, CX
	ADDQ  CX, R11
	LONG  $0xf3f8e2c4; BYTE $0xc8 // blsrq        %rax, %rax
	MOVL  BX, DX
	JNE   LBB11_15
	JMP   LBB11_18

LBB11_16:
	LONG  $0xf22862c4; BYTE $0xc1 // andnl        %ecx, %r10d, %r8d
	LEAL  0(R8)(R8*1), BX
	ORL   R10, BX
	LONG  $0xf260e2c4; BYTE $0xc9 // andnl        %ecx, %ebx, %ecx
	ANDL  $-1431655766, CX
	XORL  R10, R10
	ADDL  R8, CX
	SETCS R10
	...
	XORL  $1431655765, CX
	ANDL  BX, CX
	LONG  $0xf270e2c4; BYTE $0xc0 // andnl        %eax, %ecx, %eax
	TESTQ AX, AX
	JNE   LBB11_15
...
LBB12_2:
	...
	LEAQ -40(BP), SI
	MOVQ R14, DX
	LONG $0x000af3e8; BYTE $0x00 // callq        _vnumber
	MOVQ -40(BP), BX
	JMP  LBB12_18
...
LBB12_5:
	...
	LEAQ  -48(BP), DX
	MOVQ  R15, SI
	LONG  $0x0007e0e8; BYTE $0x00 // callq        _advance_string
	TESTQ AX, AX
	JS    LBB12_25
	MOVQ  AX, -40(BP)
	MOVQ  R15, 16(R14)
...
LBB13_45:
	...
	NOTL    DX
	MOVLQSX DX, CX
	LONG    $0xbc0f4cf3; BYTE $0xd9 // tzcntq       %rcx, %r11
	SUBQ    AX, R11
...
_advance_string:
	...
	MOVQ $-1, R8
	XORL R14, R14
	QUAD $0xffffff7c056ffec5        // vmovdqu      $-132(%rip), %ymm0  /* LCPI15_0(%rip) */
	QUAD $0xffffff940d6ffec5        // vmovdqu      $-108(%rip), %ymm1  /* LCPI15_1(%rip) */
...
LBB15_8:
	LONG  $0xf28862c4; BYTE $0xe0 // andnq        %rax, %r14, %r12
	LEAQ  0(R12)(R12*1), CX
	ORQ   R14, CX
	LONG  $0xf2f0e2c4; BYTE $0xc0 // andnq        %rax, %rcx, %rax
	ANDQ  R10, AX
	XORL  R14, R14
	ADDQ  R12, AX
	SETCS R14
	...
	XORQ  R11, AX
	ANDQ  CX, AX
	LONG  $0xf2f8e2c4; BYTE $0xdb // andnq        %rbx, %rax, %rbx
	TESTQ BX, BX
	JE    LBB15_7
	JMP   LBB15_10

LBB15_9:
	LONG $0xbc0f4cf3; BYTE $0xc0 // tzcntq       %rax, %r8
	ADDQ SI, R8
	MOVQ R8, 0(DX)
	JMP  LBB15_5

LBB15_10:
	LONG $0xbc0f48f3; BYTE $0xc3 // tzcntq       %rbx, %rax
	SUBQ DI, AX
...
LBB15_13:
	...
	QUAD  $0xfffffe8f0d74fdc5 // vpcmpeqb     $-369(%rip), %ymm0, %ymm1  /* LCPI15_0(%rip) */
	LONG  $0xf9d7fdc5         // vpmovmskb    %ymm1, %edi
	QUAD  $0xfffffea30574fdc5 // vpcmpeqb     $-349(%rip), %ymm0, %ymm0  /* LCPI15_1(%rip) */
...
LBB15_16:
	LONG $0xbc0f48f3; BYTE $0xc7 // tzcntq       %rdi, %rax
	SUBQ R9, SI
	ADDQ SI, AX
	ADDQ $1, AX
	JMP  LBB15_11
...
LBB15_21:
	LONG  $0xf208e2c4; BYTE $0xc8 // andnl        %eax, %r14d, %ecx
	LEAL  0(CX)(CX*1), BX
	ORL   R14, BX
	LONG  $0xf260e2c4; BYTE $0xc0 // andnl        %eax, %ebx, %eax
	ANDL  $-1431655766, AX
	XORL  R14, R14
	ADDL  CX, AX
	SETCS R14
	...
	XORL  $1431655765, AX
	ANDL  BX, AX
	LONG  $0xf278e2c4; BYTE $0xff // andnl        %edi, %eax, %edi
	TESTQ DI, DI
	JNE   LBB15_16
...
LBB16_61:
	...
	JL    LBB16_72
	LEAL  -22(SI), AX
	LONG  $0x4c0d8d48; WORD $0x00bf; BYTE $0x00 // leaq         $48972(%rip), %rcx  /* _P10_TAB(%rip) */
...
LBB16_69:
	...
	JB   LBB16_76
	NEGL SI
	LONG $0x03058d48; WORD $0x00bf; BYTE $0x00 // leaq         $48899(%rip), %rax  /* _P10_TAB(%rip) */
...
LBB16_73:
	...
	JA   LBB16_76
	MOVL AX, AX
	LONG $0x8f0d8d48; WORD $0x00be; BYTE $0x00 // leaq         $48783(%rip), %rcx  /* _P10_TAB(%rip) */
	LONG $0x0459fbc5; BYTE $0xc1               // vmulsd       (%rcx,%rax,8), %xmm0, %xmm0
	LONG $0x4511fbc5; BYTE $0xc0               // vmovsd       %xmm0, $-64(%rbp)
	JMP  LBB16_80
...
LBB16_76:
	...
	MOVL  R10, BX
	MOVQ  SI, -88(BP)
	LONG  $0xffe59be8; BYTE $0xff // callq        _atof_eisel_lemire64
	TESTB AX, AX
	JE    LBB16_81
	MOVQ  -88(BP), SI
	CMPL  -44(BP), $0
	...
	LEAQ  -80(BP), CX
	MOVQ  R12, DI
	LONG  $0xffe57be8; BYTE $0xff // callq        _atof_eisel_lemire64
	TESTB AX, AX
	JE    LBB16_81
...
LBB16_81:
	...
	MOVQ -104(BP), DX
	MOVQ -96(BP), CX
	LONG $0xffeb92e8; BYTE $0xff // callq        _atof_native
	LONG $0x4511fbc5; BYTE $0xc0 // vmovsd       %xmm0, $-64(%rbp)
	LONG $0x7ef9e1c4; BYTE $0xc0 // vmovq        %xmm0, %rax
	JMP  LBB16_84
...
LBB20_4:
	...
	MOVQ    -56(BP), BX
	MOVQ    BX, SI
	LONG    $0xfff1cde8; BYTE $0xff // callq        _advance_ns
	MOVLQSX 0(R12), DX
	LEAQ    -1(DX), CX
	CMPQ    R14, $-1
	JNE     LBB20_6
...
LBB20_17:
	MOVQ  R15, SI
	LEAQ  -72(BP), DX
	LONG  $0xfff437e8; BYTE $0xff // callq        _advance_string
	MOVQ  AX, R13
	TESTQ AX, AX
	JS    LBB20_57
	MOVQ  R13, 0(BX)
...
LBB20_28:
	...
	MOVQ  8(AX), SI
	SUBQ  R13, SI
	LONG  $0x000d9de8; BYTE $0x00 // callq        _skip_number
	TESTQ AX, AX
	JS    LBB20_59
	MOVQ  0(BX), CX
	ADDQ  CX, AX
...
LBB20_36:
	...
	MOVQ  R15, SI
	LEAQ  -72(BP), DX
	LONG  $0xfff2dde8; BYTE $0xff // callq        _advance_string
	MOVQ  AX, R13
	TESTQ AX, AX
	JS    LBB20_57
	MOVQ  R13, 0(BX)
...
LBB20_43:
	...
	MOVQ  8(AX), SI
	SUBQ  R13, SI
	LONG  $0x000c83e8; BYTE $0x00 // callq        _skip_number
	TESTQ AX, AX
	JS    LBB20_65
	ADDQ  AX, 0(BX)
	TESTQ R13, R13
...
_skip_string:
	...
	LEAQ  -32(BP), DX
	MOVQ  BX, SI
	LONG  $0xffedd8e8; BYTE $0xff // callq        _advance_string
	TESTQ AX, AX
	JS    LBB23_2
	ADDQ  $-1, BX
	MOVQ  AX, CX
...
_validate_string:
	...
	CMPQ R13, $64
	JB   LBB24_2
	QUAD $0xffffff55056ffec5       // vmovdqu      $-171(%rip), %ymm0  /* LCPI24_0(%rip) */
	QUAD $0xffffff6d0d6ffec5       // vmovdqu      $-147(%rip), %ymm1  /* LCPI24_1(%rip) */
	QUAD $0xffffff85156ffec5       // vmovdqu      $-123(%rip), %ymm2  /* LCPI24_2(%rip) */
	LONG $0xdb76e5c5               // vpcmpeqd     %ymm3, %ymm3, %ymm3
	MOVQ $6148914691236517205, R10
	MOVQ R14, R15

LBB24_4:
	LONG  $0x6f7e81c4; WORD $0x3c24             // vmovdqu      (%r12,%r15), %ymm4
	LONG  $0x6f7e81c4; WORD $0x3c6c; BYTE $0x20 // vmovdqu      $32(%r12,%r15), %ymm5
...
LBB24_7:
	LONG  $0xf2a0e2c4; BYTE $0xd1   // andnq        %rcx, %r11, %rdx
	MOVQ  DX, -56(BP)
	LEAQ  0(DX)(DX*1), BX
	ORQ   R11, BX
	LONG  $0xf2e0e2c4; BYTE $0xc9   // andnq        %rcx, %rbx, %rcx
	...
	XORQ  R10, CX
	ANDQ  BX, CX
	LONG  $0xf2f042c4; BYTE $0xc9   // andnq        %r9, %rcx, %r9
	JMP   LBB24_8
...
LBB24_9:
	LONG  $0xbc0f49f3; BYTE $0xc9 // tzcntq       %r9, %rcx
	LEAQ  0(CX)(R15*1), BX
	ADDQ  $1, BX
	TESTQ SI, SI
	JE    LBB24_50
...
LBB24_50:
	...
	ADDQ  BX, SI
	WORD  $0xf8c5; BYTE $0x77     // vzeroupper
	LONG  $0x00027de8; BYTE $0x00 // callq        _utf8_validate
	TESTQ AX, AX
	JS    LBB24_54
	MOVQ  -48(BP), CX
	ADDQ  0(CX), AX
...
LBB24_13:
	...
	CMPQ AX, $-1
	JNE  LBB24_57
	LONG $0xbc0f48f3; BYTE $0xc6 // tzcntq       %rsi, %rax
	ADDQ R15, AX
	JMP  LBB24_57
...
LBB24_18:
	...
	QUAD  $0xfffffd8f0d74fdc5     // vpcmpeqb     $-625(%rip), %ymm0, %ymm1  /* LCPI24_0(%rip) */
	LONG  $0xd9d7fdc5             // vpmovmskb    %ymm1, %ebx
	QUAD  $0xfffffda30d74fdc5     // vpcmpeqb     $-605(%rip), %ymm0, %ymm1  /* LCPI24_1(%rip) */
	LONG  $0xc9d7fdc5             // vpmovmskb    %ymm1, %ecx
	QUAD  $0xfffffdb70d6ffec5     // vmovdqu      $-585(%rip), %ymm1  /* LCPI24_2(%rip) */
...
LBB24_25:
	SUBQ  R12, R15
	LONG  $0xbc0f48f3; BYTE $0xf3 // tzcntq       %rbx, %rsi
	LEAQ  0(R15)(SI*1), BX
	ADDQ  $1, BX
	TESTL R9, R9
	JE    LBB24_50
...
LBB24_21:
	LONG  $0xf220e2c4; BYTE $0xd1 // andnl        %ecx, %r11d, %edx
	LEAL  0(DX)(DX*1), SI
	ORL   R11, SI
	LONG  $0xf248e2c4; BYTE $0xc9 // andnl        %ecx, %esi, %ecx
	ANDL  $-1431655766, CX
	XORL  R11, R11
	ADDL  DX, CX
	SETCS R11
	...
	XORL  $1431655765, CX
	ANDL  SI, CX
	LONG  $0xf270e2c4; BYTE $0xdb // andnl        %ebx, %ecx, %ebx
	TESTQ BX, BX
	JNE   LBB24_25
...
LBB24_29:
	...
	JNE  LBB24_57
	SUBQ R12, R15
	LONG $0xbc0f49f3; BYTE $0xc1 // tzcntq       %r9, %rax
	ADDQ R15, AX
	JMP  LBB24_57
...
_utf8_validate:
	...
	TESTQ SI, SI
	JLE   LBB25_34
	LONG  $0x800d8d4c; WORD $0x00af; BYTE $0x00 // leaq         $44928(%rip), %r9  /* _first(%rip) */
	LONG  $0x79058d4c; WORD $0x00b0; BYTE $0x00 // leaq         $45177(%rip), %r8  /* _ranges(%rip) */
	LONG  $0x93158d4c; WORD $0x0001; BYTE $0x00 // leaq         $403(%rip), %r10  /* LJTI25_0(%rip) */
	MOVQ  DI, R14
...
LBB25_7:
	MOVLQSX CX, CX
	LONG    $0xbc0f4cf3; BYTE $0xf9 // tzcntq       %rcx, %r15
	SUBQ    DX, R15
	JMP     LBB25_8
...
LJTI25_0:
	LONG $0xffffff90 // .long L25_0_set_33
	LONG $0xfffffff0 // .long L25_0_set_32
	LONG $0xffffff73 // .long L25_0_set_29
	LONG $0xffffff62 // .long L25_0_set_27
	LONG $0xffffff4d // .long L25_0_set_25
...
LBB27_9:
	...
	MOVL R15, CX
	SHLL CX, DX
	LONG $0xf268e2c4; BYTE $0xdb // andnl        %ebx, %edx, %ebx
	LONG $0xf26842c4; BYTE $0xf6 // andnl        %r14d, %edx, %r14d
	LONG $0xf26842c4; BYTE $0xdb // andnl        %r11d, %edx, %r11d

LBB27_11:
	LONG  $0xf370e2c4; BYTE $0xcb // blsrl        %ebx, %ecx
	JNE   LBB27_12
	LONG  $0xf370c2c4; BYTE $0xce // blsrl        %r14d, %ecx
	JNE   LBB27_12
	LONG  $0xf370c2c4; BYTE $0xcb // blsrl        %r11d, %ecx
	JNE   LBB27_12
	TESTL BX, BX
	JE    LBB27_19
	LONG  $0xcbbc0ff3             // tzcntl       %ebx, %ecx
	CMPQ  R9, $-1
	JNE   LBB27_81
	ADDQ  AX, CX
	MOVQ  CX, R9
...
LBB27_19:
	TESTL R14, R14
	JE    LBB27_22
	LONG  $0xbc0f41f3; BYTE $0xce // tzcntl       %r14d, %ecx
	CMPQ  R8, $-1
	JNE   LBB27_81
	ADDQ  AX, CX
	MOVQ  CX, R8
...
LBB27_22:
	TESTL R11, R11
	JE    LBB27_25
	LONG  $0xbc0f41f3; BYTE $0xcb // tzcntl       %r11d, %ecx
	CMPQ  R10, $-1
	JNE   LBB27_81
	ADDQ  AX, CX
	MOVQ  CX, R10
...
LBB27_29:
	...
	SUBQ DI, R11
	XORL AX, AX
	QUAD $0xfffffdca056f7ac5 // vmovdqu      $-566(%rip), %xmm8  /* LCPI27_7(%rip) */
	QUAD $0xfffffdd20d6f7ac5 // vmovdqu      $-558(%rip), %xmm9  /* LCPI27_8(%rip) */
	QUAD $0xfffffdda156f7ac5 // vmovdqu      $-550(%rip), %xmm10  /* LCPI27_9(%rip) */
	QUAD $0xfffffde21d6f7ac5 // vmovdqu      $-542(%rip), %xmm11  /* LCPI27_10(%rip) */
	QUAD $0xfffffdea256ffac5 // vmovdqu      $-534(%rip), %xmm4  /* LCPI27_11(%rip) */
	QUAD $0xfffffdf22d6ffac5 // vmovdqu      $-526(%rip), %xmm5  /* LCPI27_12(%rip) */
	QUAD $0xfffffdfa356ffac5 // vmovdqu      $-518(%rip), %xmm6  /* LCPI27_13(%rip) */
	MOVL $4294967295, R14
...
LBB27_30:
	...
	SHLL CX, DX
	LONG $0xf268e2c4; BYTE $0xdb   // andnl        %ebx, %edx, %ebx
	LONG $0xf26842c4; BYTE $0xed   // andnl        %r13d, %edx, %r13d
	LONG $0xf26842c4; BYTE $0xe4   // andnl        %r12d, %edx, %r12d

LBB27_32:
	LONG  $0xf368e2c4; BYTE $0xcb // blsrl        %ebx, %edx
	JNE   LBB27_33
	LONG  $0xf368c2c4; BYTE $0xcd // blsrl        %r13d, %edx
	JNE   LBB27_33
	LONG  $0xf368c2c4; BYTE $0xcc // blsrl        %r12d, %edx
	JNE   LBB27_33
	TESTL BX, BX
	JE    LBB27_40
	LONG  $0xdbbc0ff3             // tzcntl       %ebx, %ebx
	CMPQ  R9, $-1
	JNE   LBB27_83
	LEAQ  0(R11)(AX*1), R9
	ADDQ  BX, R9
...
LBB27_40:
	TESTL R13, R13
	JE    LBB27_43
	LONG  $0xbc0f41f3; BYTE $0xd5 // tzcntl       %r13d, %edx
	CMPQ  R8, $-1
	JNE   LBB27_84
	LEAQ  0(R11)(AX*1), R8
	ADDQ  DX, R8
...
LBB27_43:
	TESTL R12, R12
	JE    LBB27_46
	LONG  $0xbc0f41f3; BYTE $0xd4 // tzcntl       %r12d, %edx
	CMPQ  R10, $-1
	JNE   LBB27_84
	LEAQ  0(R11)(AX*1), R10
	ADDQ  DX, R10
...
LBB27_49:
	...
	SUBQ  DI, BX
	XORL  AX, AX
	LONG  $0x9c358d4c; WORD $0x0001; BYTE $0x00 // leaq         $412(%rip), %r14  /* LJTI27_0(%rip) */
	JMP   LBB27_51
...
LBB27_33:
	LONG $0xcabc0ff3 // tzcntl       %edx, %ecx
	JMP  LBB27_34
...
LJTI27_0:
	LONG $0xfffffea8 // .long L27_0_set_61
	LONG $0xffffff05 // .long L27_0_set_65
	LONG $0xfffffea8 // .long L27_0_set_61
	LONG $0xfffffeb8 // .long L27_0_set_57
	LONG $0xffffff05 // .long L27_0_set_65
	LONG $0xffffff05 // .long L27_0_set_65
	LONG $0xffffff05 // .long L27_0_set_65
	LONG $0xffffff05 // .long L27_0_set_65
	...
	LONG $0xffffff05 // .long L27_0_set_65
	LONG $0xffffff05 // .long L27_0_set_65
	LONG $0xfffffe6f // .long L27_0_set_54
...
_skip_positive:
	...
	SUBQ  BX, SI
	MOVQ  AX, DI
	LONG  $0xfffac2e8; BYTE $0xff // callq        _skip_number
	TESTQ AX, AX
	JS    LBB28_1
	MOVQ  0(R14), CX
	ADDQ  AX, CX
...
_print_mantissa:
	...
	SUBL    DI, AX
	MOVWLZX AX, R11
	LONG    $0x583d8d48; WORD $0x0059; BYTE $0x00 // leaq         $22872(%rip), %rdi  /* _Digits(%rip) */
...
LBB31_2:
	...
	JB   LBB31_3
	MOVL $3518437209, R8
	LONG $0x100d8d4c; WORD $0x0059; BYTE $0x00 // leaq         $22800(%rip), %r9  /* _Digits(%rip) */
...
LBB31_7:
	...
	SUBL    DX, AX
	MOVWLZX AX, AX
	LONG    $0xa9158d48; WORD $0x0058; BYTE $0x00 // leaq         $22697(%rip), %rdx  /* _Digits(%rip) */
...
LBB31_8:
	...
	JB      LBB31_10
	MOVL    AX, AX
	LONG    $0x8c0d8d48; WORD $0x0058; BYTE $0x00 // leaq         $22668(%rip), %rcx  /* _Digits(%rip) */
	MOVWLZX 0(CX)(AX*2), AX
	MOVW    AX, -2(R14)
	BYTE    $0x5b                                 // popq         %rbx
	WORD    $0x5e41                               // popq         %r14
...
_left_shift:
	...
	MOVL    SI, CX
	IMUL3Q  $104, CX, R11
	LONG    $0xb0158d48; WORD $0x008a; BYTE $0x00 // leaq         $35504(%rip), %rdx  /* _LSHIFT_TAB(%rip) */
	MOVL    0(R11)(DX*1), R8
	MOVQ    0(DI), R10
	MOVLQSX 16(DI), R9
	TESTQ   R9, R9
...
_right_shift:
	...
	MOVL R8, AX
	SARL $31, AX
	LONG $0xf27842c4; BYTE $0xd8 // andnl        %r8d, %eax, %r11d
	XORL DX, DX
	XORL AX, AX
...
_f64toa:
	MOVQ  out+0(FP), DI
	MOVSD val+8(FP), X0
	CALL  ·__native_entry__+827(SB) // _f64toa
	MOVQ  AX, ret+16(FP)
	RET
...
_html_escape:
	...
	MOVQ dp+16(FP), DX
	MOVQ dn+24(FP), CX
	CALL ·__native_entry__+9628(SB) // _html_escape
	MOVQ AX, ret+32(FP)
	RET
...
_i64toa:
	MOVQ out+0(FP), DI
	MOVQ val+8(FP), SI
	CALL ·__native_entry__+3876(SB) // _i64toa
	MOVQ AX, ret+16(FP)
	RET
...
_quote:
	...
	MOVQ dn+24(FP), CX
	MOVQ flags+32(FP), R8
	CALL ·__native_entry__+5294(SB) // _quote
	MOVQ AX, ret+40(FP)
	RET
...
_skip_array:
	...
	MOVQ p+8(FP), SI
	MOVQ m+16(FP), DX
	CALL ·__native_entry__+20928(SB) // _skip_array
	MOVQ AX, ret+24(FP)
	RET
...
_skip_object:
	...
	MOVQ p+8(FP), SI
	MOVQ m+16(FP), DX
	CALL ·__native_entry__+20965(SB) // _skip_object
	MOVQ AX, ret+24(FP)
	RET
...
_skip_one:
	...
	MOVQ p+8(FP), SI
	MOVQ m+16(FP), DX
	CALL ·__native_entry__+19085(SB) // _skip_one
	MOVQ AX, ret+24(FP)
	RET
...
TEXT ·__string_length(SB), NOSPLIT | NOFRAME, $0 - 24
	NO_LOCAL_POINTERS
...
_string_length:
	MOVQ sp+0(FP), DI
	MOVQ nb+8(FP), SI
	CALL ·__native_entry__+13595(SB) // _string_length
	MOVQ AX, ret+16(FP)
	RET
...
_u64toa:
	MOVQ out+0(FP), DI
	MOVQ val+8(FP), SI
	CALL ·__native_entry__+3971(SB) // _u64toa
	MOVQ AX, ret+16(FP)
	RET
...
_unquote:
	...
	MOVQ ep+24(FP), CX
	MOVQ flags+32(FP), R8
	CALL ·__native_entry__+7131(SB) // _unquote
	MOVQ AX, ret+40(FP)
	RET
...
_validate_one:
	...
	MOVQ p+8(FP), SI
	MOVQ m+16(FP), DX
	CALL ·__native_entry__+24465(SB) // _validate_one
	MOVQ AX, ret+24(FP)
	RET
...
_value:
	...
	CALL ·__native_entry__+14199(SB) // _value
	MOVQ AX, ret+40(FP)
	RET
...
_vnumber:
	...
	MOVQ p+8(FP), SI
	MOVQ v+16(FP), DX
	LEAQ ·__native_entry__+17099(SB), AX // _vnumber
	JMP  AX
...
_vsigned:
	...
	MOVQ p+8(FP), SI
	MOVQ v+16(FP), DX
	LEAQ ·__native_entry__+18529(SB), AX // _vsigned
	JMP  AX
...
_vstring:
	...
	MOVQ p+8(FP), SI
	MOVQ v+16(FP), DX
	LEAQ ·__native_entry__+16210(SB), AX // _vstring
	JMP  AX
...
_vunsigned:
	...
	MOVQ p+8(FP), SI
	MOVQ v+16(FP), DX
	LEAQ ·__native_entry__+18809(SB), AX // _vunsigned
	JMP  AX
